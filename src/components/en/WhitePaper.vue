<template>
    <div id="white-paper">
        <div class="content">
            <div class="title">
                <span class="ms-blue">WHITE</span><span>PAPER</span>
            </div>
            <el-rows>
                <el-col :span="8">
                    <div class="white-paper-intro ms-area">
                        ...
                        <div class="ms-btn ms-bg-yellow with-arrow white-paper-btn">WHITE PAPER </div>
                    </div>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                    <div class="register ms-area">
                        <h4 class="ms-blue">register MSSC</h4>
                        ...
                        <div class="ms-btn ms-bg-yellow with-arrow register-btn" @click="register">REGISTER</div>
                    </div>
                </el-col>
            </el-rows>
        </div>
